...
export type MergedPullRequestsQueryVariables = {
  query: Scalars['String']
};


export type MergedPullRequestsQuery = (
  { __typename?: 'Query' }
  & { search: (
    { __typename?: 'SearchResultItemConnection' }
    & { edges: Maybe<Array<Maybe<(
      { __typename?: 'SearchResultItemEdge' }
      & { node: Maybe<{ __typename?: 'App' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | (
        { __typename?: 'PullRequest' }
        & Pick<PullRequest, 'permalink' | 'title' | 'baseRefName' | 'headRefName' | 'mergedAt'>
        & { mergedBy: Maybe<(
          { __typename?: 'EnterpriseUserAccount' }
...
export type PullRequestsQuery = (
  ...
  & { repository: Maybe<(
    ...
    & { pullRequests: (
      ...
      & { nodes: Maybe<Array<Maybe<(
        { __typename?: 'PullRequest' }
        & Pick<PullRequest, 'permalink' | 'createdAt' | 'updatedAt' | 'title' | 'isDraft' | 'baseRefName' | 'headRefName'>
        & { commits: (
          { __typename?: 'PullRequestCommitConnection' }
          & { nodes: Maybe<Array<Maybe<(
            { __typename?: 'PullRequestCommit' }
